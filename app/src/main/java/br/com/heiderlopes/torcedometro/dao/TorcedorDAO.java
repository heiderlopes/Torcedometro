package br.com.heiderlopes.torcedometro.dao;
...
public class TorcedorDAO {
    ...
    public List<Torcedor> getAll() {
        ...
        String rawQuery = "SELECT t.*, c.nome FROM " + TorcedorDAO.TABELA_TORCEDOR + " t INNER JOIN " + ClubeDAO.TABELA_CLUBES
                + " c ON t." + TorcedorDAO.COLUNA_CLUBE_ID + " = c." + ClubeDAO.COLUNA_ID +
